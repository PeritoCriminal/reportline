...
| `reports` | ✅ Implementado | Editor completo (blocos, sumário, cabeçalho/rodapé, config, undo/redo); render PDF/HTML planejado ([07-reports.md](./07-reports.md), [08-report-document-render.md](./08-report-document-render.md)) |
